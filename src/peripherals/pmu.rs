...
//     }
    ...
    pub fn compute_voltage_command(&self, aldo_number: usize, voltage_in_mv: u16) -> u8 {
        let scale_from_zero = voltage_in_mv - self.min_voltage[aldo_number] as u16;
...
impl<'a> Pmu<'a> {
    ...
    fn set_aldo_voltage(&mut self, aldo_number: usize, voltage_in_mv: u16) 
    ->    Result<(), u8> 
    {
    ...
    fn set_dc4_voltage(&mut self) -> Result<bool, ()> {
        ...
        /* 1.2 V, step is 10 mV */
        let value_to_write: u16 = (1200 - XPOWERS_AXP2101_DCDC4_VOL1_MIN as u16)
            / XPOWERS_AXP2101_DCDC4_VOL_STEPS1 as u16;
    ...
    pub fn start_pmu(&mut self) -> Result<bool, ()> {
        ...
        match self.i2c.write_read(
            self.address,
            &[XPOWERS_AXP2101_CHGLED_SET_CTRL],
            &mut temp,
